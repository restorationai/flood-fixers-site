...
| --- | --- | --- |
| `flood-fixers` | client record `slug` | `narestco` |
| `Flood Fixers` | plan-input `brand.display_name` | `National Restoration Construction` |
| `Flood Fixers` | plan-input `brand.short_name` | `NARESTCO` |
| `Flood Fixers` | plan-input `brand.legal_name` | `National Restoration Construction LLC` |
| `flood-fixers.com` | client record `domain` | `narestco.com` |
| `https://flood-fixers.com` | derived | `https://narestco.com` |
| `(855) 204-1124` / `+18552041124` | brand.phone | `(206) 883-0333` / `+12068830333` |
| `` | brand.email | `info@narestco.com` |
| `24/7 Emergency Service` | brand.hours | `24/7` |
