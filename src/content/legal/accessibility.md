---
archetype: "legal"
title: "Accessibility Statement | Flood Fixers"
h1: "Accessibility Statement"
meta_description: "Accessibility Statement | {brand.display_name}."
primary_keyword: "flood fixers accessibility"
secondary_keywords: []
search_intent: "navigational_legal"
priority: 1.0
plan_hash: "53ad8d44d201f5d0"
generated_at: "2026-06-29T20:55:33.469293+00:00"
...
Our site is built with semantic HTML so that screen readers can interpret page structure accurately. Headings follow a logical hierarchy, form fields carry descriptive labels, and meaningful images include alternative text. Color contrast ratios on body text and interactive elements are maintained at or above the WCAG AA minimum. Navigation is operable by keyboard alone, and we avoid time-limited interactions that could prevent users from completing a form or reaching our contact information.

We also avoid relying on motion, autoplay media, or flashing content that could create difficulty for visitors with vestibular or photosensitive conditions.
...
Accessibility isn't a one-time checkbox. As we update content, add new pages, or integrate new tools, we review changes against WCAG 2.1 AA criteria. We welcome feedback from users with disabilities as a practical and ongoing part of that process.
