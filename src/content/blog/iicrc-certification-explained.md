...
priority: 3.6
plan_hash: "3f7b3391900df889"
generated_at: "2026-06-29T20:55:20.602901+00:00"
...
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Blog", "url": "/blog/"}, {"name": "What IICRC Certification Means (and Why You Should Hire It)"}]
faq: [{"question": "Is IICRC certification required by law in California?", "answer": "No \u2014 California does not legally require IICRC certification to perform restoration work. However, many insurance carriers and property managers specify IICRC-certified firms in their preferred vendor lists, and the IICRC's published standards (like the S500 and S520) are routinely cited in insurance disputes and litigation. Hiring a certified firm gives you a documented standard to hold the contractor to."}, {"question": "What's the difference between an IICRC Certified Firm and an individual certified technician?", "answer": "A Certified Firm is the company \u2014 it's registered with the IICRC, carries required insurance, and employs at least one certified technician. Individual certifications (like WRT, ASD, or AMRT) belong to specific people. When you hire a firm, ask which certifications the technician who will actually be on your job holds \u2014 the owner's credentials don't help if they're not the one running the drying equipment in your home."}, {"question": "How do I verify that a restoration company's IICRC certification is current?", "answer": "Go to iicrc.org and use the public search tool to look up the company by name or zip code. You can confirm both the firm's registration status and the credentials of individual technicians. Certifications expire if continuing education requirements aren't met, so it's worth checking even if a company has been around for years."}, {"question": "Does IICRC certification affect what my insurance will cover?", "answer": "It can. Some insurance policies specify that remediation must follow IICRC standards to be eligible for reimbursement, and adjusters often use those standards to evaluate whether the scope of work was appropriate. Using a non-certified contractor doesn't automatically void your claim, but it can create disputes about whether the work was done correctly \u2014 especially on mold jobs where post-clearance documentation is expected."}]
...
1. Is your firm an IICRC Certified Firm?
2. Which certifications does the technician responding to my job hold?
3. Can you provide your certification numbers so I can verify them?
